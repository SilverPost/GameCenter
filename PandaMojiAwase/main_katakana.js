...
var ANSWER_SET = [
  ...
  'トヨタ', 'ホンダ', 'スバル', 'マツダ', 'ニッサン', 'スズキ', 'ダイハツ', 'レクサス',
  'アンパンマン', 'ばいきんまん', 'ドキンちゃん', 'バタコさん', 'ダッフィー', 'シェリーメイ', 'ベイマックス', 'ドリー',
  'ミッキー', 'ミニー', 'ドナルド', 'プーさん', 'バズ', 'ウッディ', 'プルート', 'ニモ',
  'デイジー', 'シャショット', 'グーフィー', 'みずほ', 'のぞみ', 'パンダ', 'ライオン', 'ねこ',
  'うさぎ', 'キリン', 'ゴリラ', 'ニワトリ', 'ねずみ', 'ゾウ', 'てんとうむし', 'タカラトミー', 
  'ハヤト', 'アキタ', 'ツラヌキ', 'そらジロー', 'くもジロー', 'ぽつリン', 'ワンワン', 'うーたん',
  'パトカー', 'きゅうきゅうしゃ', 'バス', 'タクシー', 'ブルドーザー', 'しょうぼうしゃ', 'バイク', 'じてんしゃ',
  'ひこうき', 'ヘリコプター', 'トラック', 'ドラえもん', 'あり', 'にんじん', 'ブロッコリー', 'じゃがいも'
  ];
var DISPLAY_LETTERS = [];
